...
#
#   Last modified: Mon 29 Sep 18:31:49 2014
#
#
#----------------------------------------------------------------------------#
...
argparser.add_argument("-kzLo", type=float, default=cfgkz,
                help='Override kzLo from the config file')
argparser.add_argument("-kzHi", type=float, default=10.0,
                help='Override kzHi from the default of 10.0')
argparser.add_argument("-kzStep", type=float, default=0.1,
                help='Override kzStep from the default of 0.1')
...
for kz in kzList:
    ...
    # set up the problem at the new kz
    ...
    me = eigenvals[lead_index]

    outFile.write('%f %20.18f %20.18f\n'%(kz,real(me),imag(me)))
    outFile.flush()
