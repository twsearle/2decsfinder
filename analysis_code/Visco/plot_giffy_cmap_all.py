...
for i in range(numFrames):
    ...
    im1 = ax1.imshow(real(Psi2DList[i]), origin='lower', extent=[0,22,-1,1],
    ...
    im3 = ax3.imshow(real(Cyy2DList[i]), origin='lower', extent=[0,22,-1,1],
    ...
    im4 = ax4.imshow(real(Cxy2DList[i]), origin='lower', extent=[0,22,-1,1],
